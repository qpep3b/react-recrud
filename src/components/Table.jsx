...
function Table({
    ...
    function renderControls() {
        return (
            <div className="left">
                {add ? <AddModal columns={columns} url={url} /> : null}
                {edit ? <EditModal columns={columns} data={selectedData} url={url} /> : null}
                {remove ? (
                    <button
                        className={
                            Object.keys(selectedData).length ? "btn-flat" : "btn-flat disabled"
                        }
                                        ...
                                        {column.disableSortBy ? null : (
                                            <FontAwesomeIcon
                                                className={
                                                    column.isSorted
                                                        ? "right"
                                                        : "right grey-text text-lighten-2"
                                                }
                                                icon={
                                                    column.isSorted
                                                        ? column.isSortedDesc
